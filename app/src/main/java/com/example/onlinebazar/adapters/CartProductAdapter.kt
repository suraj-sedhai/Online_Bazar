...
import com.example.onlinebazar.databinding.CartProductItemBinding
    ...
    inner class CartProductsViewHolder( val binding: CartProductItemBinding) :
        ...
        fun bind(cartProduct: CartProduct) {
            binding.apply {
                ...
                val priceAfterPercentage = cartProduct.product.offerPercaentage.getProductPrice(cartProduct.product.price)
