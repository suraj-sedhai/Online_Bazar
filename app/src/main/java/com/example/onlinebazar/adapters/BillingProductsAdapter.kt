...
import com.example.onlinebazar.databinding.BillingProductsRvItemBinding
    ...
    inner class BillingProductsViewHolder(val binding: BillingProductsRvItemBinding): ViewHolder(binding.root) {
        ...
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                ...
                val priceAfterPercentage = billingProduct.product.offerPercaentage.getProductPrice(billingProduct.product.price)
