...
import com.example.onlinebazar.databinding.FragmentUserAccountBinding
...
import com.example.onlinebazar.viewmodel.factory.UserAccountViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.updateInfo.collectLatest {
                when (it) {
                    is Resource.Loading -> {
                        binding.buttonSave.setText("Loading...")
                    }
                    is Resource.Success -> {
